...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Employee e1 = new Employee("John", "Dog", "23/07/2010");
        Employee e2 = new Employee("Joy", "Duck", "22/09/2020");
        Employee e3 = new Employee("Onani", "Dog", "22/08/2020");
        Employee e4 = new Employee("Meg", "Duck", "23/07/2013");
        Employee e5 = new Employee("Jessy", "Dog", "23/07/2020");
